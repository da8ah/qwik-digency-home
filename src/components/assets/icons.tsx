...
// NAVBAR
export function HeroiconsSquaresPlus20Solid(
...
export function HeroiconsSquares2x220Solid(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
...
export function MdiLightningBolt(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
		<svg
			...
			key={key}
		>
			<path fill="currentColor" d="M11 15H6l7-14v8h5l-7 14v-8Z"></path>
		</svg>
	);
}

export function MdiLightningBoltCircle(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
...
// BUSINESS
export function RiAppsLine(props: QwikIntrinsicElements["svg"], key: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
		...
		>
			<path
				fill="currentColor"
				d="M6.75 2.5A4.25 4.25 0 0 1 11 6.75V11H6.75a4.25 4.25 0 0 1 0-8.5ZM9 9V6.75A2.25 2.25 0 1 0 6.75 9H9Zm-2.25 4H11v4.25A4.25 4.25 0 1 1 6.75 13Zm0 2A2.25 2.25 0 1 0 9 17.25V15H6.75Zm10.5-12.5a4.25 4.25 0 0 1 0 8.5H13V6.75a4.25 4.25 0 0 1 4.25-4.25Zm0 6.5A2.25 2.25 0 1 0 15 6.75V9h2.25ZM13 13h4.25A4.25 4.25 0 1 1 13 17.25V13Zm2 2v2.25A2.25 2.25 0 1 0 17.25 15H15Z"
			></path>
		</svg>
	);
}

export function RiCodeSSlashLine(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
...
export function RiLandscapeLine(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M11.27 12.216L15 6l8 15H2L9 8l2.27 4.216Zm1.12 2.022L14.987 19h4.68l-4.77-8.942l-2.507 4.18ZM5.348 19h7.304L9 12.219L5.348 19ZM5.5 8a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5Z"
			></path>
		</svg>
	);
}

export function RiRocketLine(props: QwikIntrinsicElements["svg"], key: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
		...
		>
			<path
				fill="currentColor"
				d="M5 13c0-5.088 2.902-9.437 7-11.182C16.097 3.563 19 7.912 19 13c0 .823-.076 1.626-.221 2.403l1.94 1.832a.5.5 0 0 1 .096.603l-2.495 4.575a.5.5 0 0 1-.793.114l-2.235-2.234a1 1 0 0 0-.707-.293H9.414a1 1 0 0 0-.707.293l-2.235 2.234a.5.5 0 0 1-.792-.114l-2.496-4.575a.5.5 0 0 1 .096-.603l1.94-1.832C5.076 14.626 5 13.823 5 13Zm1.475 6.695l.817-.817A3 3 0 0 1 9.414 18h5.171a3 3 0 0 1 2.122.878l.817.817l.982-1.8l-1.1-1.038a2 2 0 0 1-.593-1.82A11.11 11.11 0 0 0 17 13c0-3.87-1.995-7.3-5-8.96C8.995 5.7 7 9.13 7 13c0 .691.063 1.372.186 2.036a2 2 0 0 1-.593 1.82l-1.1 1.04l.982 1.8ZM12 13a2 2 0 1 1 0-4a2 2 0 0 1 0 4Z"
			></path>
		</svg>
	);
}
...
// WHYUS
export function RiWifiLine(props: QwikIntrinsicElements["svg"], key: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
...
export function RiTeamLine(props: QwikIntrinsicElements["svg"], key: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
...
export function RiCustomerService2Line(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
...
// TEAM
export function RiLinkedinFill(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
...
export function RiArrowRightLine(
	props: QwikIntrinsicElements["svg"],
	key: string,
) {
	return (
